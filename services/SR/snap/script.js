...
function redirectToCurrencyPage(currency) {
  if (currency === "SAR") {
    ...
    window.location.href = "../../../services/OMR/snap/" +
      window.location.pathname.split("/").pop();
/*  } else if (currency === "KWD") {
    window.location.href = "../../../services/KWD/snap/" +
      window.location.pathname.split("/").pop();*/
  } else if (currency === "AED") {
    window.location.href = "../../../services/AED/snap/" +
      window.location.pathname.split("/").pop();
/*  } else if (currency === "QAR") {
    window.location.href = "../../../services/QAR/snap/" +
      window.location.pathname.split("/").pop();*/
  } else {
    window.location.href = "../../../services/USD/snap/" +
      window.location.pathname.split("/").pop();      
  }
}
