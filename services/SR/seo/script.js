...
function redirectToCurrencyPage(currency) {
  if (currency === "SAR") {
    ...
    window.location.href = "../../../services/OMR/seo/" +
      window.location.pathname.split("/").pop();
/*  } else if (currency === "KWD") {
    window.location.href = "../../../services/KWD/seo/" +
      window.location.pathname.split("/").pop();*/
  } else if (currency === "AED") {
    window.location.href = "../../../services/AED/seo/" +
      window.location.pathname.split("/").pop();
/*  } else if (currency === "QAR") {
    window.location.href = "../../../services/QAR/seo/" +
      window.location.pathname.split("/").pop();*/
  } else {
    window.location.href = "../../../services/USD/seo/" +
      window.location.pathname.split("/").pop();      
  }
}
