...
function redirectToCurrencyPage(currency) {
  if (currency === "SAR") {
    ...
    window.location.href = "../../../services/OMR/youtube/" +
      window.location.pathname.split("/").pop();
/*  } else if (currency === "KWD") {
    window.location.href = "../../../services/KWD/youtube/" +
      window.location.pathname.split("/").pop();*/
  } else if (currency === "AED") {
    window.location.href = "../../../services/AED/youtube/" +
      window.location.pathname.split("/").pop();
/*  } else if (currency === "QAR") {
    window.location.href = "../../../services/QAR/youtube/" +
      window.location.pathname.split("/").pop();*/
  } else if (currency === "USD") {
    window.location.href = "../../../services/USD/youtube/" +
      window.location.pathname.split("/").pop();
  }
}
