...
function redirectToCurrencyPage(currency) {
  if (currency === "SAR") {
    ...
    window.location.href = "../../../services/OMR/twitter/" +
      window.location.pathname.split("/").pop();
/*  } else if (currency === "KWD") {
    window.location.href = "../../../services/KWD/twitter/" +
      window.location.pathname.split("/").pop();*/
  } else if (currency === "AED") {
    window.location.href = "../../../services/AED/twitter/" +
      window.location.pathname.split("/").pop();
/*  } else if (currency === "QAR") {
    window.location.href = "../../../services/QAR/twitter/" +
      window.location.pathname.split("/").pop();*/
  } else {
    window.location.href = "../../../services/USD/twitter/" +
      window.location.pathname.split("/").pop();
  }
}
