...
function redirectToCurrencyPage(currency) {
  if (currency === "SAR") {
    ...
    window.location.href = "../../../services/OMR/facebook/" +
      window.location.pathname.split("/").pop();
/*  } else if (currency === "KWD") {
    window.location.href = "../../../services/KWD/facebook/" +
      window.location.pathname.split("/").pop();*/
  } else if (currency === "AED") {
    window.location.href = "../../../services/AED/facebook/" +
      window.location.pathname.split("/").pop();
/*  } else if (currency === "QAR") {
    window.location.href = "../../../services/QAR/facebook/" +
      window.location.pathname.split("/").pop();*/
  } else {
    window.location.href = "../../../services/USD/facebook/" +
      window.location.pathname.split("/").pop();
    }
}
